...
<div id="page_content">
	<div id="page_content_inner">
		<div class="md-card uk-margin-medium-bottom">
			...
			$userorder=mysqli_query($conn,"select * from orders where order_by ='".$_GET['id']."'");
			...
			?>
				...
				<table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
					...
					<tbody>
						<?php 
							//$query=mysqli_query($conn,"select * from cartorders c join users u on c.uid=u.uid where u.role=2 ORDER BY c.pkuniquecartid DESC") or die(mysqli_error($conn));
							/*$query=mysqli_query($conn,"select * from orders where order_by='".$_GET['id']."'") or die(mysqli_error($conn));*/							
							$query=mysqli_query($conn,"select * from cartorders where uid='".$_GET['id']."' order by pkuniquecartid desc") or die(mysqli_error($conn));
						...
						?>	
									<tr>
                                       ...
                                       <td><?php echo date("d-m-Y", $row['created_on']/1000);
									   ?></td>
