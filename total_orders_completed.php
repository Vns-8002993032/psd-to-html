	...
	<div id="page_content_inner">
		<div class="md-card uk-margin-medium-bottom">
			<div class="md-card-content">
				<h1 class="uk-text-center"><b>Total Completed Orders</b></h1>
				...
				<table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
					...
					<tbody>
						...
						date_default_timezone_set('UTC+8');
							...
							$query=mysqli_query($conn,"select * from orders where delivery_status=1 group by fkcartid") or die(mysqli_error($conn));
						...
						?>	
									<tr>
                                        ...
                                        <td><?php echo date("d-m-Y",ceil($row['created_on']/1000)); ?></td>
									</tr>
						<?php }
						 ?>
                        <?php  } ?>
